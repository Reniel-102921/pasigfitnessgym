...
if (isset($_POST['pin'])) {
  ...
  if (empty($pin)) {
    ...
    $sql = "SELECT * FROM admin_pin WHERE admin_pin='$pin'";
...
<body>
  ...
  <div class="container-sm" id="containerSize">
    <div class="container loginContainer">
      <a href="delete.php"><button class="btn btn-secodary btn-lg close" name="button">&times;</button></a>
      ...
      <div class="container-content">
        ...
        ?>
        <form action="pinDelete.php" method="post">
