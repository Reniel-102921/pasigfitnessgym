            ...
            <li class="nav-item">
              ...
              <ul class="collapse show nav flex-column ms-1" id="submenu1" data-bs-parent="#menu">
                <div class="content-nav m-3">
                  <li class="w-100">
                    <a href="retrieved.php" class="nav-link px-0 ps-xl-2"> <span class="d-none d-sm-inline"><i class="fa-solid fa-arrow-rotate-right" style="font-size:17px;"></i> Refresh</span></a>
                  </li>
                </div>
                <div class="content-nav m-3">
                  <li>
                ...
                <div class="content-nav m-3" style="background-color: rgba(115, 115, 115, 0.56);border-radius: 5px;">
                  <li>
                    <a href="retrieved.php" class="nav-link px-0 ps-xl-2"> <span class="d-none d-sm-inline"><i class="fa-solid fa-file" style="font-size:17px;"></i> Retrieve Data</span></a>
                  </li>
                </div>
              </ul>
            </li>
          ...
          <div class="row">
            <div class="col-11 bg-dark mt-5 tableData">
              <div class="enrolled bg-dark position:absolute;" name="enrolled">
                <div class="row mt-3">
                  <div class="col-6">
                    <h1 style="font-size:30px">Retrieve Customer</h1>
                  </div>
                ...
                <div class="mt-4 database">
                  <table class="database-table">
                    ...
                    if (isset($_POST['searchCustomer'])) {
                      ...
                      $sql = "SELECT * FROM client_backup WHERE ID LIKE '%$searchData' or firstname LIKE '%$searchData' or datePaid LIKE '%$searchData' ORDER BY datePaid DESC";
                    } else {
                      $sql = "SELECT * FROM client_backup ORDER BY datePaid DESC";
                    }
                    ...
                    while ($row = $result->fetch_assoc()) {
                      ...
                      echo "<td> <a href='dbRetrieved.php?id=" . $row['ID'] . "'><i class='fa-solid fa-file-import' style='color:#11ba16; background-color: white; padding: 7px; border-radius: 5px'></i></a>";
                      echo "</tr>";
                    }
                    $con->close();
                    ?>
                ...
                <a href="dbDeleteAll.php"><button type="button" class="btn btn-danger deleteAll mt-3" name="button">Delete All <i class="fa-solid fa-trash-can"></i></button></a>
              </div>
            </div>
          </div>
        </div>
